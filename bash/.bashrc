...
export OSH='/home/necromancer/.oh-my-bash'
...
### ─── Functions ───────────────────────
# anything to search using duckduckgo engine
duck() {
  lynx "https://duckduckgo.com/lite/?q=$(echo "$*" | sed 's/ /+/g')"
}
...
# play any file from the local directory home/Videos
playlocal() {
  mpv "$HOME/Videos/$1"
}
